...
<html>
    ...
    <body>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="menu.jsp"><i class="las la-home la-lg"></i>Home</a></li>
                <li class="breadcrumb-item"><a href="onlineUsers.jsp"><i class="las la-globe la-lg"></i>Online Users</a></li>
                <li class="breadcrumb-item"><a href="view_feed.jsp"><i class="las la-eye la-lg"></i>View Production</a></li>
                <li class="breadcrumb-item"><a href="menu.jsp"><i class="las la-edit la-lg"></i>Feed Production</a></li>
                <li class="breadcrumb-item"><a href="logout"><i class="las la-sign-out-alt la-lg"></i>logout</a></li>  
                <li class="breadcrumb-item"><a href="help.jsp"><i class="lar la-question-circle la-lg"></i>help</a></li>  
            </ol>
        </nav>
    ...
    <center>
        ...
        <div class="container" >
            <div class="jumbotron ">
                ...
                <h2><div data-splitting>WELCOME TO ADMIN PANEL <i class="las la-user-secret"></i></div></h2>
                <br>
                <h6>This is Admin Panel, Please proceed with caution!</h6>
            </div>
        </div>
