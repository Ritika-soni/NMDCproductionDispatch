...
<html>
    ...
    <body>
        ...
        <div id="bounce"><h2 class="heading"> <center> SCREENING PLANT - II<center> </h2></div>
                        <div class="container">
                        ...
                        <div class='container'>
                            ...
                            <div class='container jumbotron jumbotron-fluid' style="background-color:#BDD5BA;">     
                                ...
                                <select id="Breakdown" multiple>            
                                    <option>701 Vibrating Screen</option> 
                                    <option>702 Belt Conveyor</option> 
                                    <option>704 Pri. Vibrating Screen</option> 
                                    <option>705 Belt Conveyor</option> 
                                    <option>706 Sec. Vibrating Screen</option> 
                                    <option>707 Belt Conveyor</option> 
                                    <option>708 Belt Conveyor</option> 
                                    <option>709 Belt Conveyor</option> 
                                    <option>710 Classifier</option> 
                                    <option>711 Dewatering Screen</option> 
                                    <option>712 Belt Conveyor</option> 
